...
\section{\textcolor{HeaderColor}{RELATED \\ SKILLS}} 
				...
				Python, Scala, Ruby, Rust, Java, Typescript, C/C++, Golang, C\#\\
\\
				{\sc Technologies/Frameworks: (listed in decreasing order of experience)} \\
				AWS S3, Apache Cassandra, Redis, PostgreSQL, MongoDB, Apache Spark, Airflow \\ Apache Storm, Apache Kafka, Elasticsearch
